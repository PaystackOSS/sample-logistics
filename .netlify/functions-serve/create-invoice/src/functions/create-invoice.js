  ...
  "node_modules/qrcode/lib/server.js"(exports2) {
    ...
    function render(renderFunc, text, params) {
      if (!params.cb) {
        return new Promise(function(resolve, reject) {
          try {
            var data2 = QRCode2.create(text, params.opts);
      ...
      try {
        var data = QRCode2.create(text, params.opts);
...
// functions/create-invoice.js
var import_qrcode = __toModule(require_lib());
